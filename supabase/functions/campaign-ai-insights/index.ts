...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const prompt = `Vos sos o Assistente da Campaña Inteligente da Vendus. Analiza os dados a seguir e produza 3 insights práticos para el gestor (en español, máximo 2 linhas cada, sin clichês). Cada insight debe ter: título corto + recomendação acionável.
