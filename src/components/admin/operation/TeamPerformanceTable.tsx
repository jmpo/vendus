...
import type { SellerPerformance } from '@/hooks/useOperationCenter';
  ...
  return (
    <Card className="border-border h-full">
      <CardHeader className="pb-3">
        <CardTitle className="text-base font-semibold">Performance da Equipo</CardTitle>
      </CardHeader>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="text-xs text-muted-foreground border-b">
                  ...
                  <th className="text-right font-medium px-2 py-2">Conversaciones</th>
                  <th className="text-right font-medium px-2 py-2">Leads</th>
                  <th className="text-right font-medium px-2 py-2">Atrasadas</th>
                  <th className="text-right font-medium px-2 py-2">Reuniões Hoy</th>
