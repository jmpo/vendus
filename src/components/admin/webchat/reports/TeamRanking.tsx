...
import type { TeamRankingRow } from '@/hooks/useAttendanceReports';
import { formatDuration } from '@/hooks/useAttendanceReports';
  ...
  return (
    <Card className="rounded-2xl border bg-card shadow-sm">
      <CardHeader className="pb-4">
        <CardTitle className="text-base font-semibold">Desempeño dos Atendentes</CardTitle>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="text-xs uppercase tracking-wide text-muted-foreground">
                  ...
                  <th className="px-2 py-2 text-right font-medium">Conversaciones</th>
