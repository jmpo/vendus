...
const OPTIONS = [
  {
    ...
    icon: Pencil,
    title: 'Crear do Zero',
    description: 'Comece con um quiz em branco e monte preguntas, lógica, resultados e acciones manualmente.',
  ...
  },
  {
    ...
    icon: Sparkles,
    title: 'Crear con IA',
    description: 'Descreva o contexto e a IA cria preguntas, opciones, lógica, puntuación, resultados e acciones.',
  ...
  },
  {
    ...
    icon: LayoutTemplate,
    title: 'Usar Template',
    description: 'Elegí um modelo pronto de quiz e personalize para su operación.',
    gradient: 'from-emerald-500/10 to-emerald-500/5',
    iconBg: 'bg-emerald-500/15 text-emerald-700 dark:text-emerald-300',
  },
];

export function QuizCreationLauncher({ open, onOpenChange, onPick }: Props) {
  return (
