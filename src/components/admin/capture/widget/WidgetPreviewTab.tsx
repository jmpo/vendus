...
export function WidgetPreviewTab({ funnel }: Props) {
...
<html lang="pt-br"><head>
  ...
  <main>
    ...
    <p>O widget abaixo será carregado exatamente como apareceria em um site real dónde usted colar o snippet de instalación.</p>
      ...
      <div className="flex flex-wrap items-center justify-between gap-2 pb-3 border-b shrink-0">
        <div className="flex items-center gap-2">
          <Badge variant={isActive ? 'default' : 'secondary'}>
            {isActive ? 'Widget ativo' : 'Borrador — solo usted vê'}
          </Badge>
          {!isActive && (
