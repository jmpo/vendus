...
const SAMPLE_DATA: Record<string, string> = {
  ...
  email: 'joao@ejemplo.com',
  amount: '₲ 297,00',
  due_date: '15/05/2026',
  invite_link: 'https://app.ejemplo.com/aceitar-convite?token=abc123',
  billing_link: 'https://app.ejemplo.com/configuracoes/cobranca',
  login_link: 'https://app.ejemplo.com/login',
  inviter_name: 'Maria Souza',
  role: 'Vendedor',
  reset_link: 'https://app.ejemplo.com/reset?token=xyz',
  message: 'Su mensaje personalizada acá.',
