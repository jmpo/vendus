// Catálogo de modelos disponibles por provedor.
// Actualizar acá siempre que sair uma versión nova.
...
export interface AIModelInfo {
  ...
  description: string;   // 1 línea explicando para o usuario
  tags: ModelTag[];
...
export const TAG_LABELS: Record<ModelTag, { label: string; className: string }> = {
  ...
  vision:         { label: 'Visión', className: 'bg-indigo-500/10 text-indigo-700 dark:text-indigo-400 border-indigo-500/20' },
  audio:          { label: 'Audio', className: 'bg-orange-500/10 text-orange-700 dark:text-orange-400 border-orange-500/20' },
};
...
export const MODELS_BY_PROVIDER: Record<AIProvider, AIModelInfo[]> = {
  // ---------------- LOVABLE AI (gateway) ----------------
  lovable: [
    { id: 'google/gemini-3-flash-preview', label: 'Gemini 3 Flash (Preview)', description: 'Próxima generación — rápido e equilibrado', tags: ['recommended', 'new', 'fastest', 'vision'], supports: ALL_TEXT_CAPS },
    { id: 'google/gemini-3.1-pro-preview', label: 'Gemini 3.1 Pro (Preview)', description: 'Topo de línea — raciocínio profundo', tags: ['most_powerful', 'new', 'vision'], supports: ALL_TEXT_CAPS },
  ...
  // ---------------- OPENAI ----------------
  openai: [
    // Última generación 2025
    { id: 'gpt-5.2', label: 'GPT-5.2', description: 'Mais recente — raciocínio top de línea', tags: ['most_powerful', 'new', 'vision'], supports: ALL_TEXT_CAPS },
    ...
    // Generación 4o aún mucho usada
    { id: 'gpt-4o', label: 'GPT-4o', description: 'Multimodal estável — visión e audio', tags: ['vision'], supports: ALL_TEXT_CAPS },
    { id: 'gpt-4o-mini', label: 'GPT-4o Mini', description: 'Barato e ótimo para chat de WhatsApp', tags: [], supports: ALL_TEXT_CAPS },
    // Audio
    { id: 'gpt-4o-transcribe', label: 'GPT-4o Transcribe', description: 'Transcripción mais recente — mejor que Whisper', tags: ['recommended', 'new', 'audio'], supports: ['audio_transcription'] },
    { id: 'gpt-4o-mini-transcribe', label: 'GPT-4o Mini Transcribe', description: 'Transcripción rápida e barata', tags: ['cheapest', 'fastest', 'audio'], supports: ['audio_transcription'] },
    ...
    { id: 'text-embedding-3-small', label: 'Text Embedding 3 Small', description: 'Predeterminado — bom custo-benefício', tags: ['recommended', 'cheapest'], supports: ['embeddings'] },
  ],

  // ---------------- ANTHROPIC (Claude) ----------------
  anthropic: [
    // Última generación 2025
    { id: 'claude-sonnet-4-5', label: 'Claude Sonnet 4.5', description: 'Mais recente — mejor para código e agentes', tags: ['recommended', 'new', 'vision'], supports: ALL_TEXT_CAPS },
    { id: 'claude-opus-4-1', label: 'Claude Opus 4.1', description: 'Topo de línea — raciocínio profundo', tags: ['most_powerful', 'vision'], supports: ALL_TEXT_CAPS },
    ...
    { id: 'claude-3-5-haiku-latest', label: 'Claude 3.5 Haiku', description: 'Generación anterior — rápido e econômico', tags: [], supports: ALL_TEXT_CAPS },
  ],
  ...
  gemini: [
    ...
    { id: 'gemini-3-flash-preview', label: 'Gemini 3 Flash (Preview)', description: 'Próxima generación — rápido e equilibrado', tags: ['recommended', 'new', 'fastest', 'vision'], supports: ALL_TEXT_CAPS },
    { id: 'gemini-2.5-pro', label: 'Gemini 2.5 Pro', description: 'Estável — contexto grande e visión', tags: ['vision'], supports: ALL_TEXT_CAPS },
    ...
    { id: 'gemini-2.0-flash', label: 'Gemini 2.0 Flash', description: 'Generación 2.0 — estável', tags: [], supports: ALL_TEXT_CAPS },
    // Embeddings
